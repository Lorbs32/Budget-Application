...
VALUES (2, '2025-03-05', 'Apartment Complex', 'Note text apartment', 500.89);
INSERT INTO transactions (line_item_id, transaction_date, merchant, note, actual_amount)
VALUES (6, '2025-03-02', 'Savvy Sliders', 'Note text restaurant', 25.15);
...
-- -- Line Items
-- INSERT INTO line_items (category_id, is_income, line_item_name, planned_amount, recurrence)
-- VALUES (1, true, 'Paycheck 1', 2000.00, 'BI_WEEKLY');
-- INSERT INTO line_items (category_id, is_income, line_item_name, planned_amount, recurrence)
-- VALUES (2, false, 'Mortgage/Rent', 500.89, 'MONTHLY');
-- INSERT INTO line_items (category_id, is_income, line_item_name, planned_amount, recurrence)
-- VALUES (2, false, 'Electricity', 101.05, 'MONTHLY');
-- INSERT INTO line_items (category_id, is_income, line_item_name, planned_amount, recurrence)
-- VALUES (3, false, 'Gas', 25.25, 'MONTHLY');
-- INSERT INTO line_items (category_id, is_income, line_item_name, planned_amount, recurrence)
-- VALUES (4, false, 'Groceries', 100.00, 'MONTHLY');
-- INSERT INTO line_items (category_id, is_income, line_item_name, planned_amount, recurrence)
-- VALUES (4, false, 'Restaurants', 75.00, 'MONTHLY');
-- INSERT INTO line_items (category_id, is_income, line_item_name, planned_amount, recurrence)
-- VALUES (5, false, 'Clothing', 20.00, 'MONTHLY');
-- INSERT INTO line_items (category_id, is_income, line_item_name, planned_amount, recurrence)
-- VALUES (5, false, 'Phone', 45.00, 'MONTHLY');
-- INSERT INTO line_items (category_id, is_income, line_item_name, planned_amount, recurrence)
-- VALUES (6, false, 'Gym', 30.00, 'MONTHLY');
-- INSERT INTO line_items (category_id, is_income, line_item_name, planned_amount, recurrence)
-- VALUES (6, false, 'Doctor/Dentist Visits', 50.00, 'MONTHLY');
-- INSERT INTO line_items (category_id, is_income, line_item_name, planned_amount, recurrence)
-- VALUES (7, false, 'Health Insurance', 125.00, 'MONTHLY');
-- INSERT INTO line_items (category_id, is_income, line_item_name, planned_amount, recurrence)
-- VALUES (7, false, 'Life Insurance', 15.50, 'MONTHLY');
-- INSERT INTO line_items (category_id, is_income, line_item_name, planned_amount, recurrence)
-- VALUES (7, false, 'Auto Insurance', 100.00, 'MONTHLY');
-- INSERT INTO line_items (category_id, is_income, line_item_name, planned_amount, recurrence)
-- VALUES (8, false, 'Emergency Fund', 200.00, 'MONTHLY');
